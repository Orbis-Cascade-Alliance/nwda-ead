...
<!--
<xsl:variable name="pathToFiles">http://nwda-db.wsulibs.wsu.edu/xsl/support/</xsl:variable>
-->

<xsl:variable name="pathToFiles">http://nwda-db.wsulibs.wsu.edu/mc_dev/xsl/print/support/</xsl:variable>

<!--
don't hit the WSU webserver:
	

	<xsl:variable name="pathToFiles">support/</xsl:variable>-->


	<xsl:variable name="styleFileName">nwda.style.print.css</xsl:variable>
	<xsl:variable name="file" select="translate(//ead/@id, ' ', '')"/>
	<xsl:variable name="dscOrder">bfu</xsl:variable><!--defunct-->
...
<!--actual-->
	...
	-->
	<xsl:param name="contactinformation_label">Repository Name</xsl:param>	
