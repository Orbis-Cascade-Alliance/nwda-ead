...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <!-- kept from original mod.dsc --><xsl:template match="*[local-name()='c01']//*[local-name()='did']"><!-- c01 only --><xsl:choose><!-- original SY code
      ...
      <!--non-unittitle,unitdate,unitid descriptive information--><!-- This now only processes the following elements within <c01>.  The context at this
			point is <c01><did>.  Lower components are processed in a separate section --><xsl:if test="string(following-sibling::*[local-name()='acqinfo'] | following-sibling::*[local-name()='accruals'] | following-sibling::*[local-name()='custodhist'] | following-sibling::*[local-name()='processinfo'] | following-sibling::*[local-name()='separatedmaterial'] |    *[local-name()='physdesc'] | *[local-name()='physloc'] | *[local-name()='origination'] | *[local-name()='note'] | following-sibling::*[local-name()='odd'] |    following-sibling::*[local-name()='scopecontent'] | following-sibling::*[local-name()='arrangement'] | following-sibling::*[local-name()='bioghist']  |             following-sibling::*[local-name()='accessrestrict'] | following-sibling::*[local-name()='userestrict'] | following-sibling::*[local-name()='note'] |             following-sibling::*[local-name()='altformavail']) and parent::*[local-name()='c01']">
         <xsl:for-each select="following-sibling::*[local-name()='acqinfo'] | following-sibling::*[local-name()='accruals'] | following-sibling::*[local-name()='custodhist'] | following-sibling::*[local-name()='processinfo'] | following-sibling::*[local-name()='separatedmaterial'] |     *[local-name()='physdesc'] | *[local-name()='physloc'] | *[local-name()='origination'] | *[local-name()='note'] | following-sibling::*[local-name()='odd'] |     following-sibling::*[local-name()='scopecontent'] | following-sibling::*[local-name()='arrangement'] | following-sibling::*[local-name()='bioghist']  |                 following-sibling::*[local-name()='accessrestrict'] | following-sibling::*[local-name()='userestrict'] | following-sibling::*[local-name()='note'] |                  following-sibling::*[local-name()='altformavail']">
