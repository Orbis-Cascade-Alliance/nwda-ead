...
<!--
  ...
  Modification by Al Cornisyh (cornish@wsu.edu) - removal of "view
  source" instruction in doctype
...
<xsl:template match="node()[nodeType()=10]">
  ...
  <SPAN class="d">&lt;!DOCTYPE <xsl:node-name/><I> (Note: Complete doctype information not available in this view)</I>&gt;</SPAN>
  </SPAN></DIV>
</xsl:template>
